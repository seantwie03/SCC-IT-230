...
![Headshot of Sean Twiehaus](./assets/headshot.jpg)
...
![Cover of the Red Hat RHCSA 10 Cert Guide: EX200 by Sander van Vugt](./assets/RHCSA10CertGuide-Cover.png)
...
```mermaid
pie
    title Graded Items by Overall Course Value
    "Lab Assignments" : 60
    "Midterm Exam" : 15
    "Final Exam" : 15
    "Attendance" : 10
...
![Happy clay figures in a zoom window](./assets/zoom-clay.png)
